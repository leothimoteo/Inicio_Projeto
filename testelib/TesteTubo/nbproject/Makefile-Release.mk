...
LDLIBSOPTIONS=../../dist/Release/MinGW-Windows/libpastacimentada.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/testetubo.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/testetubo.exe: ../../dist/Release/MinGW-Windows/libpastacimentada.a
